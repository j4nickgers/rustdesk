...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connessione alla rete Telesolver..."),
        ...
        ("Slogan_tip", "Il tuo supporto remoto professionale"),
        ...
        ("install_tip", "A causa del Controllo Account Utente (UAC), Telesolver potrebbe non funzionare correttamente come desktop remoto.\nPer evitare questo problema, fai clic sul tasto qui sotto per installare Telesolver a livello di sistema."),
        ...
        ("Turned off", "Spegni"),
        ("Language", "Lingua"),
        ("Keep RustDesk background service", "Mantieni il servizio di Telesolver in background"),
        ...
        ("Show RustDesk", "Visualizza Telesolver"),
        ("This PC", "Questo PC"),
        ("or", "O"),
        ("Elevate", "Eleva"),
        ...
        ("Exit", "Esci da Telesolver"),
        ("Open", "Apri Telesolver"),
        ...
        ("scam_text1", "Se sei al telefono con qualcuno che NON conosci NON DI TUA FIDUCIA che ti ha chiesto di usare Telesolver e di avviare il servizio, non procedere e riattacca subito."),
        ...
        ("powered_by_me", "Alimentato da Telesolver"),
        ...
        ("About RustDesk", "Info su Telesolver"),
